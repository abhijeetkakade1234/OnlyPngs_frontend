      ...
      <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
        <div className="relative">
          ...
          <div className="relative z-10 grid grid-cols-6 gap-3">
            ...
            <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 border-gray-800 bg-gray-900">
              <CardContent className="relative m-auto size-fit pt-6">
                <div className="relative flex h-24 w-56 items-center justify-center">
                  <svg className="text-gray-700 absolute inset-0 size-full" viewBox="0 0 254 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                  ...
                  <span className="mx-auto block w-fit text-5xl font-semibold text-white">AI</span>
                </div>
                <h2 className="mt-6 text-center text-3xl font-semibold text-white">Set Rules with AI</h2>
            ...
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 border-gray-800 bg-gray-900">
              <CardContent className="pt-6">
                <div className="relative mx-auto flex aspect-square size-32 items-center justify-center rounded-full border border-gray-700 before:absolute before:-inset-2 before:rounded-full before:border before:border-gray-800">
                  <Zap className="m-auto h-fit w-24 text-white" strokeWidth={1.5} />
                </div>
                <div className="relative z-10 mt-6 space-y-2 text-center">
                  <h2 className="text-lg font-medium text-white transition">Zero-Latency Execution</h2>
            ...
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 border-gray-800 bg-gray-900">
              <CardContent className="pt-6">
                <div className="pt-6 lg:px-6">
                  <svg className="w-full dark:text-gray-700" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="386" height="123" rx="10" fill="currentColor" />
                    <g clipPath="url(#clip0_0_106)">
                      <circle className="text-gray-600" cx="29" cy="29" r="15" fill="currentColor" />
                    ...
                    <defs>
                      <linearGradient id="paint0_linear_0_106" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                        <stop className="text-white/15" stopColor="currentColor" />
                ...
                <div className="relative z-10 mt-6 space-y-2 text-center">
                  <h2 className="text-lg font-medium text-white transition">The Sleeping Buy</h2>
                  <p className="text-gray-400 text-sm">
            ...
            <Card className="relative col-span-full overflow-hidden lg:col-span-3 border-gray-800 bg-gray-900">
              <CardContent className="grid pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    <h2 className="text-lg font-medium text-white transition">Set Rules with AI</h2>
                    <p className="text-gray-400 text-sm">
                      Users define complex buy/sell rules in natural language (e.g., "Buy if floor price is below 20 AVAX").
                    </p>
                  </div>
            ...
            <Card className="relative col-span-full overflow-hidden lg:col-span-3 border-gray-800 bg-gray-900">
              <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  <div className="relative flex aspect-square size-12 items-center justify-center rounded-full border border-gray-700 before:absolute before:-inset-2 before:rounded-full before:border before:border-gray-800">
                    <Moon className="m-auto size-6 text-white" strokeWidth={1} />
                  </div>
                  <div className="space-y-2">
                    <h2 className="text-lg font-medium text-white transition">The Sleeping Buy</h2>
                    <p className="text-gray-400 text-sm">
                ...
                <div className="before:bg-gray-800 relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                  <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      <span className="block h-fit rounded border border-gray-700 bg-gray-900 px-2 py-1 text-xs text-white shadow-sm">Zero-Latency</span>
                    ...
                    <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                      ...
                      <span className="block h-fit rounded border border-gray-700 bg-gray-900 px-2 py-1 text-xs text-white shadow-sm">AI Rules</span>
                    </div>
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      <span className="block h-fit rounded border border-gray-700 bg-gray-900 px-2 py-1 text-xs text-white shadow-sm">Always On</span>
                      <div className="ring-gray-900 size-7 ring-4 rounded-full bg-gray-800 flex items-center justify-center">
